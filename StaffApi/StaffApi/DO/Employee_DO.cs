...
namespace StaffApi.DO
{
    public class Employee_DO : BaseDO
    {
        ...
        /* public async Task<int> AddNewEmployee(string emp_code ,string name)
         {
             return await _dbHelper.ExecStoreProcedureAsync("AddNewEmployee", new string[] {"EMP_CODE","FULLNAME"},
                 new object[] {emp_code,name });
         }
